...
const ValidTypeCombinations = new Map<string, ExampleSucceedingMod>(
  Object.entries({
    ...
    "Multitype: CET + Native Interaction + Audioware": {
      expectedInstallerType: InstallerType.MultiType,
      inFiles: [
        ...CET_PREFIXES,
        path.join(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/`),
        path.join(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/changelog.txt`),
        path.join(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/joytoysettings.json`),
        path.join(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/${CET_INIT}`),
        path.join(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/modules/`),
        path.join(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/modules/interactionUI.lua`),
        path.join(`${CET_PREFIX}/nativeInteractions/`),
        path.join(`${CET_PREFIX}/nativeInteractions/projects/`),
        path.join(`${CET_PREFIX}/nativeInteractions/projects/dedra_sjoytoy.json`),
        ...AUDIOWARE_PATHS,
        path.join(`${AUDIOWARE_PATHS}/dedra_joytoy/`),
        path.join(`${AUDIOWARE_PATHS}/dedra_joytoy/dedra_joytoy.yaml`),
        path.join(`${AUDIOWARE_PATHS}/dedra_joytoy/joytoy_gay_m_n1.wav`),
      ],
      outInstructions: [
        copiedToSamePath(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/changelog.txt`),
        copiedToSamePath(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/joytoysettings.json`),
        copiedToSamePath(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/${CET_INIT}`),
        copiedToSamePath(`${CET_PREFIX}/Dedra's Jobs of Night City Joytoy lite/modules/interactionUI.lua`),
        copiedToSamePath(`${CET_PREFIX}/nativeInteractions/projects/dedra_sjoytoy.json`),
        copiedToSamePath(`${AUDIOWARE_PATHS}/dedra_joytoy/dedra_joytoy.yaml`),
        copiedToSamePath(`${AUDIOWARE_PATHS}/dedra_joytoy/joytoy_gay_m_n1.wav`),
      ],
    },
  }),
);
