  ...
  Object.entries({
    ...
    "Multitype: CET + Native Interaction + Audioware": {
      ...
      inFiles: [
        ...
        ...AUDIOWARE_PATHS,
        path.join(`${AUDIOWARE_PATH}\\dedra_joytoy\\`),
        path.join(`${AUDIOWARE_PATH}\\dedra_joytoy\\dedra_joytoy.yaml`),
        path.join(`${AUDIOWARE_PATH}\\dedra_joytoy\\joytoy_gay_m_n1.wav`),
      ],
      outInstructions: [
        ...
        copiedToSamePath(`${AUDIOWARE_PATH}\\dedra_joytoy\\dedra_joytoy.yaml`),
        copiedToSamePath(`${AUDIOWARE_PATH}\\dedra_joytoy\\joytoy_gay_m_n1.wav`),
      ],
    },
  }),
);
